  ...
  <aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-blue-800 dark:bg-darker md:block">
    <div class="flex flex-col h-screen">
      ...
      >
        ...
        <!--        &lt;!&ndash; Components links &ndash;&gt;-->
        <!--        <div x-data="{ isActive: false, open: false }">-->
        <!--          &lt;!&ndash; active classes 'bg-blue-100 dark:bg-blue-600' &ndash;&gt;-->
        <!--          <a-->
        <!--            href="#"-->
        <!--            class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"-->
        <!--            :class="{ 'bg-blue-100 dark:bg-blue-600': isActive || open }"-->
        ...
        <!--              class="ml-auto"-->
        <!--            >-->
        <!--              &lt;!&ndash; active class 'rotate-180' &ndash;&gt;-->
        <!--              <svg-->
        <!--                class="w-4 h-4 transition-transform transform"-->
        <!--                :class="{ 'rotate-180': open }"-->
        <!--                xmlns="http://www.w3.org/2000/svg"-->
        ...
        <!--          >-->
        <!--            &lt;!&ndash; active & hover classes 'text-gray-700 dark:text-light' &ndash;&gt;-->
        <!--            &lt;!&ndash; inActive classes 'text-gray-400 dark:text-gray-400' &ndash;&gt;-->
        <!--            <a-->
        <!--              href="#"-->
        <!--              role="menuitem"-->
        <!--              class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"-->
        ...
        <!--        <div x-data="{ isActive: false, open: false}">-->
        <!--          &lt;!&ndash; active & hover classes 'bg-blue-100 dark:bg-blue-600' &ndash;&gt;-->
        <!--          <a-->
        <!--            href="#"-->
        <!--            class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"-->
        <!--            :class="{'bg-blue-100 dark:bg-blue-600': isActive || open}"-->
